        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 animate-in fade-in slide-in-from-bottom-12 duration-1000">
            <Link 
              ...
              className="bg-transparent text-white border-2 border-white/30 px-10 py-4 rounded-md font-bold uppercase tracking-widest text-[10px] hover:bg-white/10 hover:border-white transition-all w-full sm:w-auto"
            >
              Our Products
            </Link>
            <Link 
